...
const DATA = {
  ...
  economy: {
    ...
    holidays: {
      title: "May 2026 — 4 Public Holidays",
      subtitle: "2 long weekends + 1 mega 6-day break",
      items: [
        { date: "1 May (Fri)", name: "Hari Buruh Internasional", note: "→ Long weekend May 1–3" },
        { date: "14 May (Thu)", name: "Kenaikan Yesus Kristus", note: "+ Cuti bersama 15 May → 4-day break" },
        { date: "27 May (Wed)", name: "Idul Adha 1447H", note: "+ Cuti bersama 28 May → 6-day mega break" },
        { date: "31 May (Sun)", name: "Hari Raya Waisak", note: "Links to Pancasila Day 1 June" },
      ],
      implication: "4 public holidays in May 2026 = 2 long weekends + 1 mega 6-day break → elevated mall traffic, gift purchasing, and family outing spending. Explains the +26.1% MoM GMV surge and PIM2's +54.3% MoM leap. Holiday calendar is the single biggest traffic accelerator in May.",
    },
  },
  ...
  sameStore: {
    ...
    subtitle: "Plaza Senayan · Plaza Indonesia · AEON Mall BSD · TSM Cibubur · TSM Bandung | Q2 2026 vs Q2 2025 | AOV · UPT · ASP",
  ...
  bestSellers: {
    ...
    items: [
      { rank: 1, name: "Margot Mary-Jane", image: "assets/products/best_01_margot_maryjane.png", qtyQ2: 3314, gmvQ2: 455, contribQ2: 17.2, qtyLY: 3857, growth: -8.3, gmvLY: 496, contribLY: 24.7 },
      { rank: 2, name: "Audrey", image: "assets/products/best_02_audrey.png", qtyQ2: 1527, gmvQ2: 203, contribQ2: 7.7, qtyLY: 713, growth: 128.4, gmvLY: 89, contribLY: 4.4 },
      { rank: 3, name: "Silvie", image: "assets/products/best_03_silvie.png", qtyQ2: 1077, gmvQ2: 135, contribQ2: 5.1, isNew: true },
      { rank: 4, name: "Tamia Mary-Jane A", image: "assets/products/best_04_tamia_maryjane_a.png", qtyQ2: 810, gmvQ2: 108, contribQ2: 4.1, isNew: true },
      { rank: 5, name: "Myriel", image: "assets/products/best_05_myriel.png", qtyQ2: 709, gmvQ2: 95, contribQ2: 3.6, isNew: true },
      { rank: 6, name: "Addison", image: "assets/products/best_06_addison.png", qtyQ2: 569, gmvQ2: 93, contribQ2: 3.5, qtyLY: 644, growth: -6.5, gmvLY: 99, contribLY: 5.0 },
      { rank: 7, name: "Nelly", image: "assets/products/best_07_nelly.png", qtyQ2: 487, gmvQ2: 66, contribQ2: 2.5, qtyLY: 116, growth: 325.9, gmvLY: 15, contribLY: 0.8 },
      { rank: 8, name: "Francesca", image: "assets/products/best_08_francesca.png", qtyQ2: 450, gmvQ2: 72, contribQ2: 2.7, qtyLY: 561, growth: -14.8, gmvLY: 85, contribLY: 4.2 },
      { rank: 9, name: "Margot Walker Mary-Jane", image: "assets/products/best_09_margot_walker_maryjane.png", qtyQ2: 437, gmvQ2: 58, contribQ2: 2.2, qtyLY: 460, growth: -9.8, gmvLY: 64, contribLY: 3.2 },
      { rank: 10, name: "Marah", image: "assets/products/best_10_marah.png", qtyQ2: 414, gmvQ2: 55, contribQ2: 2.1, isNew: true },
    ],
  ...
  slowMovers: {
    ...
    items: [
      { rank: 1, name: "Skyler", image: "assets/products/slow_01_skyler.png", qtyJun: 1, gmvJun: 0.13, isNew: true },
      { rank: 2, name: "Aimee", image: "assets/products/slow_02_aimee.png", qtyJun: 1, gmvJun: 0.13, isNew: true },
      { rank: 3, name: "Kamber", image: "assets/products/slow_03_kamber.png", qtyJun: 1, gmvJun: 0.13, isNew: true },
      { rank: 4, name: "Liana", image: "assets/products/slow_04_liana.png", qtyJun: 1, gmvJun: 0.14, qtyLY: 2, gmvLY: 0.24, growth: -41.5 },
      { rank: 5, name: "Hatty", image: "assets/products/slow_05_hatty.png", qtyJun: 1, gmvJun: 0.14, isNew: true },
      { rank: 6, name: "Georgia", image: "assets/products/slow_06_georgia.png", qtyJun: 2, gmvJun: 0.30, qtyLY: 11, gmvLY: 1.19, growth: -95.3 },
      { rank: 7, name: "Tila", image: "assets/products/slow_07_tila.png", qtyJun: 3, gmvJun: 0.31, isNew: true },
      { rank: 8, name: "Ryan Slip-On", image: "assets/products/slow_08_ryan_slipon.png", qtyJun: 3, gmvJun: 0.35, qtyLY: 43, gmvLY: 7.41, growth: -71.0 },
      { rank: 9, name: "Natalie", image: "assets/products/slow_09_natalie.png", qtyJun: 3, gmvJun: 0.40, isNew: true },
      { rank: 10, name: "Aria Walker", image: "assets/products/slow_10_aria_walker.png", qtyJun: 4, gmvJun: 0.44, qtyLY: 8, gmvLY: 1.52, growth: -74.6 },
    ],
  ...
  mso: {
    ...
    unavailableAcrossAll: {
      ...
      images: {
        silvie: "assets/products/best_03_silvie.png",
        margot_mary_jane: "assets/products/best_01_margot_maryjane.png",
        cecily: "assets/products/nostock_cecily.png",
      },
      cecilyNote: null,
    },
  },
